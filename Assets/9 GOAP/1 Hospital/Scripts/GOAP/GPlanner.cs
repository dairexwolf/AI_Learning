...
public class GPlanner
{
    ...
    private bool BuildGraph(GNode parent, List<GNode> leaves, List<GAction> usuableActions, Dictionary<string, int> goal)
    {
        ...
        foreach (GAction action in usuableActions)
        {
            if (action.IsAchievableGiven(parent.state))
            {
                ...
                GNode GNode = new GNode(parent, parent.cost + action.cost, currentState, action);
                ...
                else
                {
                    ...
                    bool found = BuildGraph(GNode, leaves, subset, goal);
                    if (found)
                        foundPath = true;
                }
            }
